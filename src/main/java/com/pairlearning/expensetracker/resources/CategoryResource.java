...
public class CategoryResource {
    ...
    //specify a type of HttpServletRequest and Spring will automatically pass the
    //current request object here
    //remember the userId was attached into the token payload and we can extract it here
    @GetMapping("")
